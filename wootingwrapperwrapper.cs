...
namespace WootingAnalogSDKZ
{
    ...
    public static class WootingAnalogSDK
    {
        ...
        /// </returns>
        public static int Initialise(out WootingAnalogResult result)
        {
            ...
            {
                result = (WootingAnalogResult)initResult;
                return -1;
            }
        }
        ...
        /// </returns>
        ///Fallback handler could not load library H:/Steam/steamapps/common/My Summer Car/mysummercar_Data/Mono/wooting_analog_wrapper
        ...
        /// </returns>
        public static float ReadAnalog(ushort code, out WootingAnalogResult result, ulong deviceID = 0)
        {
            ...
            {
                result = (WootingAnalogResult)(int)res;
                return -1.0f;
            }
        }
